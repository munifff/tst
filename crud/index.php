...
$api_url_pemesanan = "http://192.168.252.192/bis/bis_revisi/user/soap_pembayaran.php";
...
$api_url_helpdesk = "http://192.168.252.52/tst/bis/crud_mobil/rest_helpdesk.php";
    ...
    <table border="1" cellspacing="0" cellpadding="10">
        ...
        <tbody>
            ...
            if (isset($data_helpdesk['data']) && is_array($data_helpdesk['data']) && !empty($data_helpdesk['data'])) {
                ...
                echo "<tr><td colspan='7'>Tidak ada data helpdesk.</td></tr>";
            }
            ?>
        </tbody>
    </table>
