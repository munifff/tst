...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validasi data input
    if (isset($input['id_pelanggan']) && isset($input['judul']) && isset($input['deskripsi'])) {
        // Proses untuk menyimpan data ke database
        $id_pelanggan = $conn->real_escape_string($input['id_pelanggan']);
        ...
        $query = "INSERT INTO helpdesk (id_pelanggan, judul, deskripsi, tanggal_buat, status) 
